...
function RegisterForm({ isOpen, onClose }) {
  ...
  return (
          ...
          <div className="space-y-0">
            ...
            <div className="mt-7 grid grid-cols-1 gap-x-8 gap-y-7">
              <Textarea
                ...
                onChange={handleChange}
                placeholder="Cuéntanos brevemente tu trayectoria como artesano/a..."
              />
              <Textarea
    ...
    {enviado && (
      <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6 bg-[#1a0f06]/70 backdrop-blur-sm">
        <div className="w-full max-w-md rounded-[2rem] bg-[#F4F0E6] p-8 sm:p-10 text-center shadow-2xl shadow-black/50">
          ...
          <p className="mt-3 font-sans text-sm leading-relaxed text-cafe-noir/80">
            Tu información ha sido recibida correctamente. Nuestro equipo administrativo
            validará tu postulación y pronto recibirás tus credenciales de acceso en el
